...
| W2-276 | | B2 | J08 | CRANE | CLAIMED-CRANE | | architecture: worker + D1 scaffold (D1 "ferrum-os-data", binding DB, id 049b0f34-adb3-4f7f-85ec-60170019f3a0; schema: rates, parcels, leads, plans; wrangler.jsonc gains worker + bindings) — built per AGENT_INTERFACE spec (W2-305) |
