...
| W2-307 | | B2 | J08 | CRANE | CLAIMED-CRANE | | CONCIERGE — deterministic intent-router assistant: build-time catalog knowledge, polite script set per COMPLIANCE_GATE voice, quick replies, router.push maneuvers into pages AND tools, polite fallback + lead handoff, ARIA + mobile, no external calls |
