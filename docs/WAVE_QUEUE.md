...
| W2-277 | | B2 | J08 | CRANE | CLAIMED-CRANE | | architecture: provider seams (LandRecordsProvider, RatesProvider, GeometryExporter) + INDICATIVE sample parcel/rate datasets — after W2-276; built per AGENT_INTERFACE spec (W2-305) |
