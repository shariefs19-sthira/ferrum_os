...
| W2-274 | | B2 | J08 | CRANE | CLAIMED-CRANE | | architecture: MCP server (ulpin-demo, testfit, boq-estimate, plan-gen, is-check) — after W2-276; built per AGENT_INTERFACE spec (W2-305) |
