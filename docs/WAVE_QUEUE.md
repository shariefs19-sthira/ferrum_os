...
| W2-320 | | B2 | J08 | CRANE | CLAIMED-CRANE | | TRANSACT_VISIBILITY — add Transact to the navbar products menu, footer products column, home showcase as a 10th card, sitemap.ts, and the concierge catalog. No copy changes to the Transact page itself. |
