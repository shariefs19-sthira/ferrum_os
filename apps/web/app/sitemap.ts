...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const articleRoutes = [
    ...
    '/resources/research-cases',
    '/resources/research-cases/nbc-2016-scope',
    '/resources/research-cases/rera-act-2016-framework',
    '/resources/research-cases/open-government-data-construction',
    '/resources/research-cases/dilrmp-land-records-modernization',
