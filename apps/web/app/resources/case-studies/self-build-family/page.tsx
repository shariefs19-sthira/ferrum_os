        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-600">
              ...
              quality without professional oversight.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              the self-build process. The solution included detailed planning tools, 
                ...
                tracking to empower the family with professional-grade management capabilities.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              of reliable contractors for future improvements.
            </p>
          </section>
        </div>
      </div>
