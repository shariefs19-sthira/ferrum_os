...
import LandIntelFeatures from "../LandIntelFeatures"
import PlotEstimator from "../PlotEstimator"
import { SoilCard } from "./SoilCard"

export default function LandIntelLookup() {
  ...
  return (
    <div className="mx-auto max-w-2xl rounded-xl border border-gray-100 bg-white p-6 shadow-lg">
      <div className="mb-6 flex items-center justify-between gap-3">
        <h3 className="text-2xl font-bold tracking-tight text-gray-900">ULPIN Lookup</h3>
