...
describe('UlpinMapExplorer W-85 parcel finder', () => {
  ...
  it('RULE 41(1): every interactive control in the toolbar and record card is at least 44px tall (min-h-11 / bracket equivalent)', () => {
    ...
    const controls = Array.from(container.querySelectorAll('[data-find-parcel-toolbar] button, [data-find-parcel-toolbar] input, [data-ulpin-record-card] button, [data-map-view-toolbar] button'))
