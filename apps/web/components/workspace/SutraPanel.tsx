...
export default function SutraPanel({ onEvent, activeProduct }: { onEvent:(event:SutraEvent)=>void; activeProduct?: CockpitProduct }) {
  ...
  const options: Record<Stage,{label:string;command:string;citation?:string}[]> = {
    ...
    output: [{label:"Export DXF",command:"export DXF",citation:outputCitation},{label:"Share brief",command:"share workspace brief",citation:outputCitation},{label:"Reset model",command:"reset model"}],
  }
