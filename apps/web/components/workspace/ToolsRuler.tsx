...
export default function ToolsRuler({
  ...
  return (
    <aside aria-label="Workspace tools" className={`border-relume-border bg-relume-surface-secondary ${rail ? "h-full border-l" : "border-b"}`}>
      <div className={`flex items-center gap-2 px-4 py-2 sm:px-6 ${rail ? "h-full flex-col overflow-y-auto px-2 py-4" : "mx-auto max-w-relume-container overflow-x-auto"}`}>
        ...
        <button
          ...
          className={`${rail ? "mt-auto" : "ml-auto"} min-h-11 shrink-0 rounded-full border border-relume-border bg-relume-surface px-4 text-sm font-medium text-relume-ink hover:bg-relume-surface-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-relume-ink`}
