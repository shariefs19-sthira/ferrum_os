...
export default function WorkflowRail({ activeProduct, onProductChange, staleProducts = [] }: WorkflowRailProps) {
  ...
  return (
    <nav aria-label="Project workflow" className="relative z-50 border-b border-relume-border bg-relume-surface px-3 py-2 sm:px-4" data-workflow-rail>
      <div className="mx-auto max-w-relume-container">
        <div className="hidden min-[1280px]:flex min-[1280px]:items-center min-[1280px]:gap-1">
          ...
          <details ref={advancedDetailsRef} className="relative ml-2" data-advanced-workflows>
            ...
            <div className="absolute right-0 top-full z-30 mt-2 w-72 rounded-relume border border-relume-border bg-relume-surface p-2 shadow-xl">
        ...
        <div className="flex items-center gap-2 min-[1280px]:hidden">
          <details ref={mobileDetailsRef} className="relative min-w-0 flex-1" data-mobile-workflow>
            ...
            <div className="absolute left-0 top-full z-30 mt-2 max-h-[min(70vh,34rem)] w-[min(22rem,calc(100vw-1.5rem))] overflow-y-auto rounded-relume border border-relume-border bg-relume-surface p-2 shadow-xl">
