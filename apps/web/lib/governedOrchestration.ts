...
export const governedOrchestrationStages: GovernedOrchestrationStage[] = [
  ...
  { id: 'site-instruction', title: 'Site instruction', product: 'BuildOS', stateChange: 'An approved instruction reaches the responsible site team.', evidence: 'Instruction revision, approver, recipients and acknowledgement' },
  { id: 'acceptance-evidence', title: 'Acceptance evidence', product: 'BuildOS', stateChange: 'Completion is supported by inspection evidence.', evidence: 'Checklist, photos, test records, date and responsible reviewer' },
  { id: 'controlled-closure', title: 'Controlled closure', product: 'BuildOS', stateChange: 'The chain closes only after every hold and acceptance condition is resolved.', evidence: 'Closure authority, linked records and immutable audit trail' },
]
